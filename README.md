...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-07 12:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f6aacbf7-2cc6-43fd-ab16-8dd18eee6fbf.git
$ cd f6aacbf7-2cc6-43fd-ab16-8dd18eee6fbf
```
